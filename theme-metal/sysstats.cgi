...
local $rv;
$rv .= sprintf "<img src=\"$gconfig{'webprefix'}/theme-metal/images/bar_red.gif\" width=\"%s\" height=\"10\">",
	int($bar_width*$used/$total)+1;
if ($blue) {
	$rv .= sprintf "<img src=\"$gconfig{'webprefix'}/theme-metal/images/bar_blue.gif\" width=\"%s\" height=\"10\">",
		$bar_width - int($bar_width*$used/$total)-1;
	}
else {
	$rv .= sprintf "<img src=\"$gconfig{'webprefix'}/theme-metal/images/bar_white.gif\" width=\"%s\" height=\"10\">",
		$bar_width - int($bar_width*$used/$total)-1;
	}
return $rv;
}
...
$rv .= sprintf "<img src=\"$gconfig{'webprefix'}/theme-metal/images/bar_red.gif\" width=\"%s\" height=\"10\">", $w1;
$rv .= sprintf "<img src=\"$gconfig{'webprefix'}/theme-metal/images/bar_purple.gif\" width=\"%s\" height=\"10\">", $w2;
$rv .= sprintf "<img src=\"$gconfig{'webprefix'}/theme-metal/images/bar_blue.gif\" width=\"%s\" height=\"10\">", $w3;
$rv .= sprintf "<img src=\"$gconfig{'webprefix'}/theme-metal/images/bar_grey.gif\" width=\"%s\" height=\"10\">",
	$bar_width - $w1 - $w2 - $w3;
return $rv;
}
