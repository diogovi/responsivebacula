...
print '<script src="' . $gconfig{'webprefix'} . 'js/vendor/modernizr.js"></script>' , "\n";
...
<div class="off-canvas-wrap fixed" data-offcanvas>
  <div class="inner-wrap">
    <nav class="top-bar tab-bar">
      ...
      <ul class="title-area">
	<li class="name row"><h1><a href="#">
	  <span class="bacula-title">Bacula</span>
	  <span class="backups-title"> Backups</span></a></h1>
	</li>
      </ul>
      </div>
  
      <!-- Logo -->
      <div class="large-4 columns hide-for-medium hide-for-small central-logo">
	<img class="bacula_logo" src="img/logos/bacula_logo.png" alt="Bacula Backups">
      </div>


  
      <section class="right-small sidebar">
